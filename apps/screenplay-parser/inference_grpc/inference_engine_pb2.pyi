...
class GenerateStreamChunk(_message.Message):
    __slots__ = ("token_ids", "prompt_tokens", "completion_tokens", "audio_data", "sampling_rate", "audio_format")
    ...
    sampling_rate: int
    audio_format: str
    def __init__(self, token_ids: _Optional[_Iterable[int]] = ..., prompt_tokens: _Optional[int] = ..., completion_tokens: _Optional[int] = ..., audio_data: _Optional[bytes] = ..., sampling_rate: _Optional[int] = ..., audio_format: _Optional[str] = ...) -> None: ...

class GenerateComplete(_message.Message):
    __slots__ = ("output_ids", "finish_reason", "prompt_tokens", "completion_tokens", "audio_data", "sampling_rate", "audio_format")
    ...
    sampling_rate: int
    audio_format: str
    def __init__(self, output_ids: _Optional[_Iterable[int]] = ..., finish_reason: _Optional[str] = ..., prompt_tokens: _Optional[int] = ..., completion_tokens: _Optional[int] = ..., audio_data: _Optional[bytes] = ..., sampling_rate: _Optional[int] = ..., audio_format: _Optional[str] = ...) -> None: ...
