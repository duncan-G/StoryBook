...
from src.audio_model.encoder_config import HiggsAudioEncoderConfig

# Register the custom encoder config with transformers' CONFIG_MAPPING
CONFIG_MAPPING.register("higgs_audio_encoder", HiggsAudioEncoderConfig, exist_ok=True)
